...
function initCharts() {
  ...
  if($('#trendChart')) new Chart($('#trendChart'),{type:'line',data:{labels:['2월','3월','4월','5월','6월','7월','8월'],datasets:[{data:[1920,2140,2080,2370,2510,2526,2840],borderColor:'#151515',backgroundColor:'rgba(21,21,21,.06)',fill:true,tension:.38,pointRadius:3,pointBackgroundColor:'#151515'}]},options:{responsive:true,maintainAspectRatio:false,plugins:{legend:{display:false}},scales:{x:{grid:{display:false}},y:{grid,border:{display:false}}}}});
  if($('#visitChart')) new Chart($('#visitChart'),{type:'doughnut',data:{labels:['네이버','인스타그램','거주지 근처','지인 소개','기타'],datasets:[{data:[34,26,19,14,7],backgroundColor:['#151515','#555','#888','#bbb','#e2e0db'],borderWidth:0}]},options:{responsive:true,maintainAspectRatio:false,cutout:'66%',plugins:{legend:{position:'bottom',labels:{boxWidth:8,usePointStyle:true,padding:14,font:{size:10}}}}}});
  if($('#branchChart')) new Chart($('#branchChart'),{type:'bar',data:{labels:['강남','청담','홍대','잠실','분당','수원','목동','일산'],datasets:[{data:[412,368,331,301,284,246,221,198],backgroundColor:'#252525',borderRadius:5,barThickness:22}]},options:{responsive:true,maintainAspectRatio:false,plugins:{legend:{display:false}},scales:{x:{grid:{display:false}},y:{grid,border:{display:false}}}}});
  if($('#concernChart')) new Chart($('#concernChart'),{type:'bar',data:{labels:['손상모','건조함','볼륨 없음','곱슬','얇아짐','두피 가려움'],datasets:[{data:[54,46,38,31,26,21],backgroundColor:['#151515','#393939','#5e5e5e','#888','#aaa','#ccc'],borderRadius:5}]},options:{indexAxis:'y',responsive:true,maintainAspectRatio:false,plugins:{legend:{display:false}},scales:{x:{grid,border:{display:false}},y:{grid:{display:false},border:{display:false}}}}});
}
