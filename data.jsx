...
const SERVICES = [
  {
    ...
    title: "프로덕트 설계",
    titleKo: "프로덕트 설계",
    lead: "스타트업의 0→1과 1→100을 모두 경험한 12년차의 시선으로, 비즈니스 가설과 기술 의사결정을 같은 테이블에서 정리합니다.",
  ...
  },
  {
    ...
    title: "모바일 앱",
    titleKo: "모바일 앱",
    lead: "Flutter 단일 코드베이스로 iOS·Android를 동시에. 필요하면 네이티브(Kotlin·Swift)까지 직접 작성합니다.",
    items: ["Flutter · Dart", "iOS (Swift)", "Android (Kotlin · Java)", "Firebase · Agora · Twilio", "출시·운영"],
  },
  {
    n: "03",
    title: "백엔드 · 인프라",
    titleKo: "백엔드 · 인프라",
    lead: "트래픽 폭발을 직접 막아본 사람만 짤 수 있는 서버. Node·Go·Python에 AWS·GCP 인프라까지 한 사람이 책임집니다.",
    items: ["Node.js (Koa · Nest · Express)", "Go · Python · PHP", "GraphQL · REST", "AWS (ECS · Aurora Serverless · Lambda)", "Firebase · Cloud Functions"],
  },
  {
    n: "04",
    title: "웹 · 관리자",
    titleKo: "웹 · 관리자",
    lead: "운영자가 실제로 ‘쓰는’ 관리자 도구. 데이터 흐름부터 권한 모델까지 같이 설계합니다.",
    items: ["Next.js · Vue · Svelte · Angular", "TypeScript · React", "디자인 시스템", "CMS · 어드민", "그로스 분석"],
  },
];
